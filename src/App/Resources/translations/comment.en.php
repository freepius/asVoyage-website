...
return ['comment' => [
    ...
    'creation.errors]' => '<a href="#comment-post">Adding a comment</a> : one or more errors !',
    'count'             => '0 comments]',
    ...
    'updating.errors]' => '<a href="#comment-post">Updating of the comment</a> : one or more errors !',
