...
return ['comment' => [
    ...
    'creation.error(s)' => '<a href="#post-comment">Ajout d\'un commentaire</a> : il y a une/des erreur/s !',
    ...
    'updating.error(s)' => '<a href="#post-comment">Mise à jour du commentaire</a> : il y a une/des erreur/s !',
